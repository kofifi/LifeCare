...
public interface IRoutineService
{
    ...
    Task<bool> ToggleStepAsync(int routineId, int stepId, DateOnly date, bool completed, string? note, string userId);
    ...
    Task<bool> ToggleStepProductAsync(int routineId, int stepId, int productId, DateOnly date, bool completed,
        string userId);
